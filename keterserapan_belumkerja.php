...
$file=mysqli_query($koneksi,"SELECT * FROM users where status_user='BELUM KERJA' ");
?>
<!DOCTYPE html>
<html lang="en">
<head>
                        ...
                        if (isset($_GET["detail"]))
                        {
                            ...
                            <a href='keterserapan_kerja.php' class='btn btn-primary'>ALUMNI BEKERJA</a>
                             <a href='keterserapan_belumkerja.php' class='btn btn-danger'>ALUMNI BELUM BEKERJA</a>
                               <a href='keterserapan_kerja_cetak.php?status_user=%27".BELUM.'%20'.KERJA."%27' target='_blank' class='btn btn-success'>CETAK DATA</a>
