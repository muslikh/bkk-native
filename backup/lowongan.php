...
<br>
                        ...
                        }elseif($_GET['diterima'])
                        {
                            ...
                            $pesan = date("d-m-Y");
                            $diterima = mysqli_query($koneksi,"UPDATE lamaran SET status='DITERIMA',pesan='$pesan' where id_lamaran=$id");
                        ...
                        {
                            $id = $_GET['ditolak'];
                            $ditolak = mysqli_query($koneksi,"UPDATE lamaran SET status='DITOLAK' where id_lamaran=$id ");
